...
// @retval None
//------------------------------------------//
//L_LEFT Mosfet_Q5 TIM3_CH1 PA6
//H_LEFT Mosfet_Q3 TIM1_CH1N PA7
void TIM_1_Init (void)
{
    ...
    TIM1->SMCR |= TIM_SMCR_SMS_2 | TIM_SMCR_SMS_1 | TIM_SMCR_TS_1;    //trigger mode link timer3    
    // TIM1->SMCR = 0x0000;
    ...
    //en OPM con ARR manejo el ciclo por arriba de CCR1
    TIM1->CCR1 = DUTY_50_PERCENT;
...
void TIM_3_Init (void)
{
    ...
    TIM3->CCMR1 = 0x0060;            //CH1 output PWM mode 1 (channel active TIM3->CNT < TIM3->CCR1)
                                     //CH2 output PWM mode 2 (channel active TIM3->CNT > TIM3->CCR1)
